            ...
            <div class="row">
                <div class="col-lg-12">
                	<table class="adminMain-table">
                		<tr>
                			<td><a class="btn btn-info btn-lg btn-block" href="memberManage.do" role="button">회원관리</a></td>
                		</tr>
                		<tr>
...
<!--                 		<tr> -->
<!--                 			<td><a class="btn btn-info btn-lg btn-block" href="sponsorManage.do" role="button">후원관리</a></td> -->
<!--                 		</tr> -->
                	</table>
                </div>	
            </div>
