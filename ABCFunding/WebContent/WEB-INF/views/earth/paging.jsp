...
%>
			<div style="float:left; width:96%; text-align:center;"> 
				<a href="#none" title="처음페이지" onclick="goPage('0');"><img src="<%=application.getContextPath()%>/img/arrow_first.gif" alt="처음페이지" style="width:9px; height:9px;"/></a>&nbsp;		
		    <%
		    	if (screenStartPageIndex > 1)
		    	{
		    %>
		        	<a href="#none" title="이전페이지" onclick="goPage('<%=screenStartPageIndex-1%>');"><img src="<%=application.getContextPath()%>/img/arrow_pre.gif" alt="이전페이지" style="width:9px; height:9px;"/></a>&nbsp;	
			<%
				}
		    ...
		    <%		}
		    	...
		    	{
		    %>	
		            <a href="#none" title="다음페이지" onclick="goPage('<%=screenEndPageIndex %>');"><img src="<%=application.getContextPath()%>/img/arrow_next.gif" alt="다음페이지" style="width:9px; height:9px;"/></a>&nbsp;
		    <%
		    	} // end if
		    ...
		    %>
		        	<a href="#none" title="마지막페이지" onclick="goPage('<%=end_page %>');" ><img src="<%=application.getContextPath()%>/img/arrow_end.gif" alt="마지막페이지" style="width:9px; height:9px;" /></a>
			</div>		
